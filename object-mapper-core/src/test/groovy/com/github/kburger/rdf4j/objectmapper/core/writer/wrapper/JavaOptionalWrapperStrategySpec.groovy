...
class JavaOptionalWrapperStrategySpec extends Specification {
    /** Subject under test. */
    def strategy = new JavaOptionalWrapperStrategy()
    ...
    def "supports"() {
        ...
        null                                          || false
        new Object()                                  || false
        com.google.common.base.Optional.of("example") || false
        Optional.empty()                              || true
    ...
    def "unwrap empty"() {
        when:
        strategy.unwrap(Optional.empty())
